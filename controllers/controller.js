...
router.get('/scrape', function(req, res) {
  ...
  request('http://www.atpworldtour.com/en/news/news-filter-results/all/all/all/all/all/', function(error, response, html) {
    ...
    $('h3.listing-title').each(function(i, element) {
        ...
        result.link = "http://www.atpworldtour.com" + $(this).children().attr("href");
